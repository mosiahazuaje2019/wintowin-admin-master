...
export class UsersComponent implements OnInit {
  ...
  sendMail(name, email){
    ...
    '<p>Estamos conformando una comunidad que permita contar con una oferta y demanda suficiente de movilidad grauita, segura y comoda, por esto el servicio de la aplicaci&oacute;n empezar&aacute; efectivamente desde el <strong>1ro de Agosto de 2020</strong>.</p>'+
    '<p>Agradecemos tu paciencia, recuerda mantener instalada las App para particpar en los sorteos que llevar&aacute; a cabo WIntowin entre los usuarios activos, te invitamos a consultar nuestra pag&iacute;na web www.wintowin.com.co y nuestras redes sociales, encontrar&aacute;s todos los videos tutoriales de funcionalidad de la aplicaci&oacute;n.</p>'+
