...
export class UsersComponent implements OnInit {
  ...
  sendMail(name, email){
    ...
    '<div class="clearfix colelem" style="z-index:2;background-color:#39B54A;position:relative;margin-right:-10000px;width:100%;">'+
    ...
    '<p style="text-align:center; color:#ffffff">¡Hola '+name+'!</p></div></div>'+
    ...
    '<p>Felicidades, has aprobado nuestro proceso de verificaci&oacute;n Satisfactoriamente, a partir de este momento quedas activo en Wintowin.</p>'+
    '<p>Estamos conformando una comunidad que permita contar con una oferta y demanda suficiente de movilidad grauita, segura y comoda, por esto el servicio de la aplicaci&oacute;n empezar&aacute; estar&aacute para viajes en las pr&oacuteximas semanas.</p>'+
    '<p>Recuerda mantener instalada la App y empazar a usarla una vez este activa para participar en el sorteo de un Smartphone de &uacuteltima generaci&oacuten y otros premios, te invitamos a consultar nuestra p&aacutegina web www.wintowin.com.co, nuestras redes sociales y contactarnos en nuestros canales de soporte, queremos que estes listo.</p>'+
    '<h6>Preparate para el cambio</h6></div>'+
    ...
    '<p style="text-align:center; color:#ffffff">WIN to WIN</p></div></div>'+
    ...
    '<p>¿Tienes dudas? Env&iacute;anos un mensaje a soporte@wintowin.com.co</p></div><div class="verticalspacer" data-offset-top="600" data-content-above-spacer="599" data-content-below-spacer="61" data-sizePolicy="fixed" data-pintopage="page_fixedLeft"></div>'
    +'</div></div>';
